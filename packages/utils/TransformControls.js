...
class TransformControlsGizmo extends Object3D {
  constructor() {
    ...
    matRed.color.setHex(0xff5e58);

    const matGreen = gizmoMaterial.clone();
    matGreen.color.setHex(0x7cd99e);
    ...
    matYellowTransparent.color.setHex(0xffb816);
    matYellowTransparent.opacity = 0.25;

    const matYellow = gizmoMaterial.clone();
    matYellow.color.setHex(0xffb816);
    ...
    const pickerTranslate = {
      ...
      RZ: [[new Mesh(bottomPickGeometry, matInvisible), [0, 0, 0], [0, 0, 0]]],
    ...
    // this.add((setupGizmo(rotateRing)));
